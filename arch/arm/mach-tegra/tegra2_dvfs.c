...
{/* 200, 400, 600, 800, 1000, 1200, 1400 MHz */
	800, 850, 900, 950, 1000, 1125
};
...
static int tegra2_dvfs_rel_vdd_cpu_vdd_core(struct dvfs_rail *vdd_cpu, struct dvfs_rail *vdd_core)
{
...
static int tegra2_dvfs_rel_vdd_core_vdd_aon(struct dvfs_rail *vdd_core, struct dvfs_rail *vdd_aon)
{
...
static struct dvfs dvfs_init[] = {
	/* Core voltages (mV) altered:   950,    1000,   1050,   1100,   1150,   1200,   1250 */
	CORE_DVFS("emc",     -1, 1, KHZ, 47500,  57000,  333000, 333000, 380000, 666000, 760000),

	/* Cpu voltages (mV):	   800, 850, 900, 950, 1000, 1100 */
	...
	CPU_DVFS("cpu", 0, 3, MHZ, 200, 400, 600, 800, 1000, 1200),

	CPU_DVFS("cpu", 1, 0, MHZ, 200, 400, 600, 800, 1000, 1200),
	CPU_DVFS("cpu", 1, 1, MHZ, 200, 400, 600, 800, 1000, 1200),
	CPU_DVFS("cpu", 1, 2, MHZ, 200, 400, 600, 800, 1000, 1200),
	CPU_DVFS("cpu", 1, 3, MHZ, 200, 400, 600, 800, 1000, 1200),

	CPU_DVFS("cpu", 2, 0, MHZ, 200, 400, 600, 800, 1000, 1200),
	CPU_DVFS("cpu", 2, 1, MHZ, 200, 400, 600, 800, 1000, 1200),
	CPU_DVFS("cpu", 2, 2, MHZ, 200, 400, 600, 800, 1000, 1200),
	CPU_DVFS("cpu", 2, 3, MHZ, 200, 400, 600, 800, 1000, 1200),
	/* 																*/
	...
	/* GPU */
	CORE_DVFS("2d",      -1, 1, KHZ, 133000, 171000, 247000, 300000, 300000, 300000, 400000),
   ...
   // CORE_DVFS("mpe",      1, 1, KHZ, 142500, 190000, 275500, 300000, 300000, 300000, 300000),
	...
	CORE_DVFS("mpe",      3, 1, KHZ, 190000, 237500, 300000, 300000, 300000, 300000, 300000),
  ...
  //  CORE_DVFS("sclk",     1, 1, KHZ, 123500, 159500, 207000, 240000, 240000, 264000, 277500),
	...
	CORE_DVFS("sclk",     3, 1, KHZ, 152000, 180500, 229500, 260000, 260000, 285000, 300000),
   ...
   // CORE_DVFS("vde",      1, 1, KHZ, 123500, 152000, 237500, 300000, 300000, 300000, 300000),
	...
	CORE_DVFS("vde",      3, 1, KHZ, 152000, 209000, 285000, 300000, 300000, 300000, 300000),
	/* What is this? */
