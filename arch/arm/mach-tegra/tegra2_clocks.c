...
static int tegra2_pll_clk_set_rate(struct clk *c, unsigned long rate)
{
	...
	//If required rate is not available in pll's frequency table, prepare parameters manually
	if (sel->input_rate == 0) {
		unsigned long cfreq;
...
static struct clk_pll_freq_table tegra_pll_x_freq_table[] = 
{
	...
	{ 13000000, 1400000000, 862,  8,  1, 12},    /* Actual is 1400.75 MHz */
	...
	/* 800 MHz */
	{ 12000000, 800000000, 800, 12, 1, 12},
	{ 13000000, 800000000, 800, 13, 1, 12},
	{ 19200000, 800000000, 667, 16, 1, 8},   /* Actual is 800.4 MHz */
	{ 26000000, 800000000, 800, 26, 1, 12},

	/* 600 MHz */
	{ 12000000, 600000000, 600, 12, 1, 12},
	{ 13000000, 600000000, 600, 13, 1, 12},
	{ 19200000, 600000000, 500, 16, 1, 8},   
	{ 26000000, 600000000, 600, 26, 1, 12},

	/* 400 MHz */
	{ 12000000, 400000000, 400, 12, 1, 12},
	{ 13000000, 400000000, 400, 13, 1, 12},
	{ 19200000, 400000000, 334, 16, 1, 8},   /* Actual is 400.8 MHz */ 
	{ 26000000, 400000000, 400, 26, 1, 12},
...
{
	{ freq_table_1p2GHz, 0, 1 },
	{ freq_table_1p4GHz, 0, 1 },
};
